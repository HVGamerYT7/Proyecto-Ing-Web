...
const obtenerUsuarios = (req:any,res:any) => {
...
const buscarUsuario = (nombre: string) => {
...
const cambiarNombreUsuario = (id: number, nuevoNombre: string) => {
...
const cambiarCorreo = (id: number, nuevoCorreo: string) => {
